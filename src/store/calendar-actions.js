...
export const createEventHandler = (event, token) => {
  return async (dispatch) => {
    const url =
      "https://carpe-diem-calendar-6b211-default-rtdb.europe-west1.firebasedatabase.app/" +
      token +
      "/events.json";
    ...
    await fetchFromFirebase(
      { url: url, method: "POST", body: event },
      responeHandler
    );
  };
};

export const updateEventHandler = (event, token) => {
  return async (dispatch) => {
    const url =
      "https://carpe-diem-calendar-6b211-default-rtdb.europe-west1.firebasedatabase.app/" +
      token +
    ...
    await fetchFromFirebase(
      { url, method: "PATCH", body: event },
      responeHandler
    );
  };
};

export const deleteEventHandler = (event, token) => {
  return async (dispatch) => {
    const url =
      "https://carpe-diem-calendar-6b211-default-rtdb.europe-west1.firebasedatabase.app/" +
      token +
...
export const loadEventsHandler = (token) => {
  return async (dispatch) => {
    const id = token ? token : "globals";
    const url =
      "https://carpe-diem-calendar-6b211-default-rtdb.europe-west1.firebasedatabase.app/" +
      id +
      "/events.json";
